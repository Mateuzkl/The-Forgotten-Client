...
RewardChest::RewardChest(uint16_t type, bool /* paginated */) :
    Container(type, items[type].maxItems) // chama o construtor válido
{
    // Se quiser armazenar "paginated", você pode fazer isso aqui.
}
