...
static constexpr auto STATUS_SERVER_NAME = "Natala Engine 0.0.1";
static constexpr auto STATUS_SERVER_VERSION = "Natala TFS 1.5.4";
static constexpr auto STATUS_SERVER_DEVELOPERS = "Alola";
