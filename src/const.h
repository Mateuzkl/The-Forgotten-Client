...
#define CLIENT_OVERRIDE_FILE_VERSION 860
...
enum GameFeatures
{
	...
	GAME_FEATURE_BASE_SKILL_U16,
	GAME_FEATURE_DOUBLE_PLAYER_GOODS_MONEY,
	GAME_FEATURE_EXTENDED_CLIENT_PING,
	GAME_FEATURE_ITEM_TIER_BYTE,
	//End Features
	GAME_FEATURE_LAST
};
