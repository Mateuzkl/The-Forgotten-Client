...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaPlayerGetAccountManagerMode(lua_State* L);
		...
		// Aura functions (extended API)
		static int luaPlayerHasAura(lua_State* L);
		static int luaPlayerGetCurrentAura(lua_State* L);
		static int luaPlayerSetCurrentAura(lua_State* L);
