...
bool ConfigManager::load()
{
	...
	boolean[GAIN_EXP_ON_GUILD_MEMBERS] = getGlobalBoolean(L, "gainExpOnGuildMembers", false);
	boolean[GAIN_EXP_ON_PARTY_MEMBERS] = getGlobalBoolean(L, "gainExpOnPartyMembers", false);
	boolean[GAIN_EXP_ON_SAME_IP_MEMBERS] = getGlobalBoolean(L, "gainExpOnSameIpMembers", false);
	...
	boolean[ACCOUNT_MANAGER] = getGlobalBoolean(L, "accountManager", false);
	...
	boolean[GENERATE_ACCOUNT_NUMBER] = getGlobalBoolean(L, "generateAccountNumber", false);
	...
	integer[NEW_PLAYER_SPAWN_POS_X] = getGlobalNumber(L, "newPlayerSpawnPosX", 0);
	integer[NEW_PLAYER_SPAWN_POS_Y] = getGlobalNumber(L, "newPlayerSpawnPosY", 0);
	integer[NEW_PLAYER_SPAWN_POS_Z] = getGlobalNumber(L, "newPlayerSpawnPosZ", 0);
	integer[NEW_PLAYER_TOWN_ID] = getGlobalNumber(L, "newPlayerTownId", 1);
	integer[NEW_PLAYER_LEVEL] = getGlobalNumber(L, "newPlayerLevel", 1);
	integer[NEW_PLAYER_MAGIC_LEVEL] = getGlobalNumber(L, "newPlayerMagicLevel", 0);
	integer[TOGGLE_MOUNT_DELAY] = getGlobalNumber(L, "toggleMountDelay", 100);
