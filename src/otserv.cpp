...
void mainLoader(int, char*[], ServiceManager* services)
{
    ...
    std::cout << ">> Checking world type... " << g_config.getString(ConfigManager::WORLD_TYPE) << std::endl;
	std::cout << ">> Initializing game state and binding services..." << std::endl;
	...
	std::cout << ">> Bound Ports: "
		...
		<< g_config.getNumber(ConfigManager::LOGIN_PORT) << std::endl;

	std::cout << ">> Global IP address: "
		<< g_config.getString(ConfigManager::IP_STRING) << std::endl;

	uint32_t ipAddress = g_config.getNumber(ConfigManager::IP);
	...
	std::cout << ">> Everything smells good, server is starting up..." << std::endl;
